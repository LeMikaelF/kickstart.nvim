-- from https://raw.githubusercontent.com/JoosepAlviste/dotfiles/refs/heads/master/config/nvim/lua/j/telescope_custom_pickers.lua
...
local function run_live_grep(current_input)
  ...
  require('telescope_pretty_pickers').pretty_grep_picker {
    picker = 'live_grep',
    options = {
